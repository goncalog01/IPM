...
{ 
  ...
  text("Para utilizar as sugestões, fazer swipe na coluna respetiva;", width/2, height/2 + start_button.size().height + 6);
  text("Para mudar o teclado fazer swipe horizontal.", width/2, height/2 + start_button.size().height + 26);
  imageMode(CENTER);
  image(tip1, width/8, height/2 + start_button.size().height + 130,190, 190);
  image(tip2, width/2, height/2 + start_button.size().height + 130,190, 190);
  image(tip3, width*7/8, height/2 + start_button.size().height + 130,190, 190);
  pop();
